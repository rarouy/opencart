<!DOCTYPE html>
<!-- saved from url=(0056)https://wpthemesgrid.com/themes/free/eshop/checkout.html -->
<html lang="zxx"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<!-- Web Font -->
	<link href="./checkout_files/css" rel="stylesheet">
	...
	<!-- Magnific Popup -->
    <link rel="stylesheet" href="./checkout_files/magnific-popup.min.css">
	<!-- Font Awesome -->
    <link rel="stylesheet" href="./checkout_files/font-awesome.css">
	<!-- Fancybox -->
	<link rel="stylesheet" href="./checkout_files/jquery.fancybox.min.css">
	<!-- Themify Icons -->
    <link rel="stylesheet" href="./checkout_files/themify-icons.css">
	<!-- Jquery Ui -->
    <link rel="stylesheet" href="./checkout_files/jquery-ui.css">
	<!-- Nice Select CSS -->
    <link rel="stylesheet" href="./checkout_files/niceselect.css">
	<!-- Animate CSS -->
    <link rel="stylesheet" href="./checkout_files/animate.css">
	<!-- Flex Slider CSS -->
    <link rel="stylesheet" href="./checkout_files/flex-slider.min.css">
	<!-- Owl Carousel -->
    <link rel="stylesheet" href="./checkout_files/owl-carousel.css">
	<!-- Slicknav -->
    <link rel="stylesheet" href="./checkout_files/slicknav.min.css">
	
	<!-- Eshop StyleSheet -->
	<link rel="stylesheet" href="./checkout_files/reset.css">
	<link rel="stylesheet" href="./checkout_files/style.css">
...
<body class="js">
				...
				<div class="row">
					<div class="col-12">
						<div class="bread-inner">
							<ul class="bread-list">
								<li><a href="https://wpthemesgrid.com/themes/free/eshop/index1.html">Home<i class="ti-arrow-right"></i></a></li>
								<li class="active"><a href="https://wpthemesgrid.com/themes/free/eshop/blog-single.html">Checkout</a></li>
							</ul>
						</div>
					</div>
				</div>
				...
				<div class="row"> 
					<div class="col-lg-8 col-12">
						<div class="checkout-form">
							...
							<!-- Form -->
							<form class="form" method="post" action="https://wpthemesgrid.com/themes/free/eshop/checkout.html#">
								<div class="row">
					...
					<div class="col-lg-4 col-12">
						<div class="order-details">
							...
							<div class="single-widget payement">
								<div class="content">
									<img src="./checkout_files/payment-method.png" alt="#">
								</div>
							</div>
							...
							<div class="single-widget get-button">
								<div class="content">
									<div class="button">
										<a href="https://wpthemesgrid.com/themes/free/eshop/checkout.html#" class="btn">proceed to checkout</a>
									</div>
								</div>
							</div>
							<!--/ End Button Widget -->
					...
					<div class="row">
						<div class="col-lg-8 offset-lg-2 col-12">
							...
							<div class="inner">
								...
								<form action="https://wpthemesgrid.com/themes/free/eshop/mail/mail.php" method="get" target="_blank" class="newsletter-inner">
					...
					<div class="row">
						<div class="col-lg-5 col-md-6 col-12">
							...
							<div class="single-footer about">
								<div class="logo">
									<a href="https://wpthemesgrid.com/themes/free/eshop/index.html"><img src="./checkout_files/logo2.png" alt="#"></a>
								</div>
						...
						<div class="col-lg-2 col-md-6 col-12">
							...
							<div class="single-footer links">
								<h4>Information</h4>
								<ul>
									<li><a href="https://wpthemesgrid.com/themes/free/eshop/checkout.html#">About Us</a></li>
									<li><a href="https://wpthemesgrid.com/themes/free/eshop/checkout.html#">Faq</a></li>
									<li><a href="https://wpthemesgrid.com/themes/free/eshop/checkout.html#">Terms &amp; Conditions</a></li>
									<li><a href="https://wpthemesgrid.com/themes/free/eshop/checkout.html#">Contact Us</a></li>
									<li><a href="https://wpthemesgrid.com/themes/free/eshop/checkout.html#">Help</a></li>
								</ul>
							</div>
							<!-- End Single Widget -->
						</div>
						<div class="col-lg-2 col-md-6 col-12">
							...
							<div class="single-footer links">
								...
								<ul>
									<li><a href="https://wpthemesgrid.com/themes/free/eshop/checkout.html#">Payment Methods</a></li>
									<li><a href="https://wpthemesgrid.com/themes/free/eshop/checkout.html#">Money-back</a></li>
									<li><a href="https://wpthemesgrid.com/themes/free/eshop/checkout.html#">Returns</a></li>
									<li><a href="https://wpthemesgrid.com/themes/free/eshop/checkout.html#">Shipping</a></li>
									<li><a href="https://wpthemesgrid.com/themes/free/eshop/checkout.html#">Privacy Policy</a></li>
								</ul>
							</div>
							<!-- End Single Widget -->
						</div>
						<div class="col-lg-3 col-md-6 col-12">
							...
							<div class="single-footer social">
								...
								<!-- End Single Widget -->
								<ul>
									<li><a href="https://wpthemesgrid.com/themes/free/eshop/checkout.html#"><i class="ti-facebook"></i></a></li>
									<li><a href="https://wpthemesgrid.com/themes/free/eshop/checkout.html#"><i class="ti-twitter"></i></a></li>
									<li><a href="https://wpthemesgrid.com/themes/free/eshop/checkout.html#"><i class="ti-flickr"></i></a></li>
									<li><a href="https://wpthemesgrid.com/themes/free/eshop/checkout.html#"><i class="ti-instagram"></i></a></li>
								</ul>
							</div>
							<!-- End Single Widget -->
						</div>
				...
				<div class="container">
					<div class="inner">
						<div class="row">
							...
							<div class="col-lg-6 col-12">
								<div class="right">
									<img src="./checkout_files/payments.png" alt="#">
								</div>
							</div>
						</div>
					</div>
	...
	<!-- Jquery -->
    <script src="./checkout_files/jquery.min.js.download"></script>
    <script src="./checkout_files/jquery-migrate-3.0.0.js.download"></script>
	<script src="./checkout_files/jquery-ui.min.js.download"></script>
	<!-- Popper JS -->
	<script src="./checkout_files/popper.min.js.download"></script>
	<!-- Bootstrap JS -->
	<script src="./checkout_files/bootstrap.min.js.download"></script>
	<!-- Color JS -->
	<script src="./checkout_files/colors.js.download"></script>
	<!-- Slicknav JS -->
	<script src="./checkout_files/slicknav.min.js.download"></script>
	<!-- Owl Carousel JS -->
	<script src="./checkout_files/owl-carousel.js.download"></script>
	<!-- Magnific Popup JS -->
	<script src="./checkout_files/magnific-popup.js.download"></script>
	<!-- Fancybox JS -->
	<script src="./checkout_files/facnybox.min.js.download"></script>
	<!-- Waypoints JS -->
	<script src="./checkout_files/waypoints.min.js.download"></script>
	<!-- Countdown JS -->
	<script src="./checkout_files/finalcountdown.min.js.download"></script>
	<!-- Nice Select JS -->
	<script src="./checkout_files/nicesellect.js.download"></script>
	<!-- Ytplayer JS -->
	<script src="./checkout_files/ytplayer.min.js.download"></script>
	<!-- Flex Slider JS -->
	<script src="./checkout_files/flex-slider.js.download"></script>
	<!-- ScrollUp JS -->
	<script src="./checkout_files/scrollup.js.download"></script>
	<!-- Onepage Nav JS -->
	<script src="./checkout_files/onepage-nav.min.js.download"></script>
	<!-- Easing JS -->
	<script src="./checkout_files/easing.js.download"></script>
	<!-- Active JS -->
	<script src="./checkout_files/active.js.download"></script>

<a id="scrollUp" href="https://wpthemesgrid.com/themes/free/eshop/checkout.html#top" style="position: fixed; z-index: 2147483647; display: none;"><span><i class="fa fa-angle-up"></i></span></a></body></html>